...
import { OfficerApvProfiles } from './OfficeApvProfileCollection';

/* eslint prefer-arrow-callback: "off",  no-unused-expressions: "off" */
/* eslint-env mocha */

if (Meteor.isClient) {
  describe('OfficerApvProfileCollection Meteor Methods', function testSuite() {
    it('Can define, update, and removeIt', async function test1() {
      ...
      const collectionName = OfficerApvProfiles.getCollectionName();
      ...
      expect(OfficerApvProfiles.isDefined(docID)).to.be.true;
      let doc = OfficerApvProfiles.findDoc(docID);
      ...
      doc = OfficerApvProfiles.findDoc(docID);
      ...
      expect(OfficerApvProfiles.isDefined(docID)).to.be.false;
    });
  });
}
