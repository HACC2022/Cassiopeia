...
import { FinalApvProfiles } from './FinalApvProfileCollection';

/* eslint prefer-arrow-callback: "off",  no-unused-expressions: "off" */
/* eslint-env mocha */

if (Meteor.isClient) {
  describe('FinalpvProfileCollection Meteor Methods', function testSuite() {
    it('Can define, update, and removeIt', async function test1() {
      ...
      const collectionName = FinalApvProfiles.getCollectionName();
      ...
      expect(FinalApvProfiles.isDefined(docID)).to.be.true;
      let doc = FinalApvProfiles.findDoc(docID);
      ...
      doc = FinalApvProfiles.findDoc(docID);
      ...
      expect(FinalApvProfiles.isDefined(docID)).to.be.false;
    });
  });
}
